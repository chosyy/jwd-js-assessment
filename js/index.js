...
window.addEventListener('DOMContentLoaded', () => {
  ...
  start.addEventListener('click', function (e) {
    ...
    var timeleft = 60;
      timeVar = setInterval(function countdown(){
  ...
  const quizArray = [
    ...
    },
    {
      ...
      o: ['Everest', 'Makalu', 'Kilimanjaro', 'Cho Oyu'],
      a: 1,
    },
    {
      q: 'What is the smallest city in the world',
      o: ['Perth', 'Vatican', 'San Marino', 'Monaco'],
      a: 2,
    },
  ];
  ...
  const calculateScore = () => {
    ...
    calculatedScore.innerHTML = `You have ${score} out of five questions accurate`;
    scroll(0,0);
  };
